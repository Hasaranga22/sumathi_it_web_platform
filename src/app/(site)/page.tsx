...
const partners = [
  ...
  { name: "DJI Enterprise", logo: "/images/partners/dji.svg" },
  { name: "HPE", logo: "/images/partners/hpe.svg" },
      ...
      <section className="border-y border-slate-200 bg-white py-12">
        <div className="container-padded overflow-hidden">
          <div className="relative">
            <div className="flex animate-[marquee_40s_linear_infinite] gap-16 hover:[animation-play-state:paused]">
